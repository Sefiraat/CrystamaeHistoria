...
public class PlayerStatUtils {
    ...
    public static void addChronicle(Player player, StoriedBlockDefinition definition) {
        addChronicle(player.getUniqueId(), definition);
    }

    public static void addChronicle(UUID player, StoriedBlockDefinition definition) {
    ...
    public static int getChronicle(Player player, StoriedBlockDefinition definition) {
        return getChronicle(player.getUniqueId(), definition);
    }

    public static int getChronicle(UUID player, StoriedBlockDefinition definition) {
        String path = MessageFormat.format("{0}.{1}.{2}.Times_Chronicled", player, StatType.STORY, definition.getMaterial());
        return CrystamaeHistoria.getConfigManager().getPlayerStats().getInt(path);
    }
