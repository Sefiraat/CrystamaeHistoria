...
public class StoryUtils {
    ...
    List<Story> getAllStories(ItemStack itemStack) {
        return DataTypeMethods.getCustom(itemStack.getItemMeta(), CrystamaeHistoria.getKeys().getPdcStories(), PersistentStoriesDataType.TYPE);
    }
    ...
    public static void applyStory(ItemStack itemStack, Story story) {
        ...
        storyList.add(story);
        DataTypeMethods.setCustom(im, CrystamaeHistoria.getKeys().getPdcStories(), PersistentStoriesDataType.TYPE, storyList);
